...
function EmpleadoScreen (){
  ...
  return(
    ...
    >
      <Stack.Screen name="Empleados" component={PlusWorkers} options={{ headerLeft: () => {
        return (
            <Icon
              name="menu"
              onPress={() => navigation.dispatch(DrawerActions.openDrawer())}
      ...
      <Stack.Screen name="Registrar Empleado" component={FormRegisEmpleado}>
  ...
  return (
    <Drawer.Navigator 
     screenOptions={{headerShown:false}}>
      ...
      <Drawer.Screen name="Articulos" component={ArticulosScreen}  options={{drawerIcon: ({focused, size}) => (<MaterialCommunityIcons name= "cart-minus" size={25} color="#778899" />), }}/>
      <Drawer.Screen name="Empleado" component={EmpleadoScreen}  options={{drawerIcon: ({focused, size}) => (<MaterialCommunityIcons name= "account" size={25} color="#778899" />), }}/>
    </Drawer.Navigator>
  );
};
